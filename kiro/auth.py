...
class KiroAuthManager:
    ...
    def _load_credentials_from_file(self, file_path: str) -> None:
        ...
        try:
            ...
            # Support both camelCase (Kiro IDE) and snake_case (CLI tools) formats
            ...
            elif "profile_arn" in data:
                self._profile_arn = data["profile_arn"]
            ...
            # Parse expiresAt / expires_at (support both camelCase and snake_case)
            ...
            if expires_str:
                try:
                    ...
                    logger.warning(f"Failed to parse expiresAt/expires_at: {e}")
